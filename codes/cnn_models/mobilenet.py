...
base_model = applications.MobileNet(weights= None, include_top=False, input_shape= (img_height,img_width,1))
...
with open("grayscale_mobilenet_{0:.1%}.json".format(accuracy), "w") as json_file:
    json_file.write(model_json)
# serialize weights to HDF5
w_file = "grayscale_mobilenet_{0:.1%}.h5".format(accuracy)
model_final.save_weights(w_file, overwrite=True)
print("Saved model to disk as grayscale_mobilenet_{0:.1%}.h5".format(accuracy))

#%%

path = "/home/selen/Desktop/esl_paper/mobilenet/grayscale_mobilenet_88.4%"
