...
model = efn.EfficientNetB1(include_top=False, input_shape=(128,128,1), weights=None)
...
with open("grayscale_efficientnetB1_{0:.1%}.json".format(accuracy), "w") as json_file:
    json_file.write(model_json)
# serialize weights to HDF5
w_file = "grayscale_efficientnetB1_{0:.1%}.h5".format(accuracy)
model_final.save_weights(w_file, overwrite=True)
print("Saved model to disk as grayscale_mobilenetV2_*.h5")

#%%

path = "/home/selen/Desktop/esl_paper/efficientnetB1/grayscale_efficientnetB1_89.0%"
